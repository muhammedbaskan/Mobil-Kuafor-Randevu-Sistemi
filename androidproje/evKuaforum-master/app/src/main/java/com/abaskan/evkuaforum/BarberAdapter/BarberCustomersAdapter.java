...
public class BarberCustomersAdapter extends RecyclerView.Adapter<BarberCustomersAdapter.BarberCustomersHolder>{
    ...
    public BarberCustomersAdapter(Context context, ArrayList<String> userNameList, ArrayList<String> appointmentTimeList, ArrayList<String> serviceNameList, ArrayList<String> userIdList, ArrayList<Integer> totalPriceList, ArrayList<String> adressList, ArrayList<Long> appointmentLongList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final BarberCustomersHolder holder, @SuppressLint("RecyclerView") final int position) {
